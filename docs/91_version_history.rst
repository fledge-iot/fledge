...
- **Plugins**
    ...
    - New Features:
       ...
       - Addition of operation support to the control input of the MQTT scripted north plugin
       - The PI Server South plugin registers for Stream Updates for all PI Points generated by the point search.
    ...
    - Bug Fix:
       ...
       - The configuration of the bucket storage service had incorrect displays of the the items in the category name and the description of the security category for the service. This has now been corrected.
