...
@pytest.fixture
def start_south_north(reset_and_start_fledge, add_south, south_branch, start_north_pi_server_c_web_api,
                      remove_data_file, remove_directories,
                      fledge_url, pi_host, pi_port, pi_admin, pi_passwd, pi_db, asset_name=ASSET):
    """ This fixture
    ...
    south_plugin = "coap"
    add_south(south_plugin, south_branch, fledge_url, service_name="bCoAP FOGL-2964")
