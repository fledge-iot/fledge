...
class TestConfigurationManager:
    ...
    async def test_delete_parent_category_recursively(self, mocker, reset_singleton):
        @asyncio.coroutine
        def mock_coro(a, b):
            return expected_result
        ...
        ret_val = await c_mgr.delete_parent_category_recursively("A")
        assert expected_result == ret_val
    ...
    async def test_delete_parent_category_recursively_exception(self, mocker, reset_singleton):
        @asyncio.coroutine
        def mock_coro(a, b):
            return expected_result
        ...
        with pytest.raises(ValueError) as excinfo:
            await c_mgr.delete_parent_category_recursively("A")
        assert str(msg) == str(excinfo.value)
