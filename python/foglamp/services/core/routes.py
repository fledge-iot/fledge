...
def setup(app):
    ...
    # Notification
    app.router.add_route('POST', '/foglamp/notification', notification.add_notification)
    app.router.add_route('PUT', '/foglamp/notification', notification.update_notification)
    app.router.add_route('GET', '/foglamp/notification', notification.get_notification)
