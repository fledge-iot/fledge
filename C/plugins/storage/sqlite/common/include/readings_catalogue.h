...
public:
	...
	long long     getIncGlobalId() {return m_ReadingsGlobalId++;};
	long long     getMinGlobalId (sqlite3 *dbHandle);
	long long     getGlobalId() {return m_ReadingsGlobalId;};
...
private:
	...
	long long     calculateGlobalId (sqlite3 *dbHandle);
