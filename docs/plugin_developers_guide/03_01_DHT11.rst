...
.. |DHT Repo| raw:: html
   ...
   <a href="https://github.com/fledge/fledge-south-dht11" target="_blank">Fledge DHT11 South Plugin</a>
...
Needless to say, the North plugin will send the buffered data to the PI system using the OMF plugin or any otehr north system using the appropriate north plugin.
