...
class SendingProcess:
    ...
    def __init__(self):
        ...
        self._memory_buffer_max_size = 10
    ...
    async def send_data(self, stream_id):
        ...
        self._memory_buffer = [None for x in range(self._memory_buffer_max_size)]
