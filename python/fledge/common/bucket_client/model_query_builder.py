...
class ModelQueryBuilder(object):
    """ Payload Builder to be used in Python client for Bucket Service
    ...
    def __init__(self, initial_payload=OrderedDict()):
        ...
        self.__class__.query_payload['attributes'] = {'type': 'model'}
    ...
    def MATCH(cls, **kwargs):
        ...
        for k,v in kwargs.items():  # arg[1] is assumed to be '=' for now
            cls['attributes'][k] = v
