...
class TestMicroserviceManagementClient:
    ...
    def test_register_service_good_id(self):
        ...
        request_patch.assert_called_once_with(body='{"keys": "vals"}', method='POST', url='/foglamp/service')
...
#=================================
    def test_register_interest_good_id(self):
        ...
        request_patch.assert_called_once_with(body='{"category": "cat", "service": "msid"}', method='POST', url='/foglamp/interest')
        assert ret_value == {'id' : 'bla'}
