...
A number of performance counters can be collected in the south service to help characterise the performance of the service.

.. note::

   This is intended to provide input into the tuning of the service and the collection of these counters should not be enabled during production use of the product.
...
.. list-table::
    ...
    * - Percentage readings sent
      - Closely related to the above the as the percentage of each block read that was actually sent.
