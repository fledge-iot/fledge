...
def pytest_addoption(parser):
    ...
    parser.addoption("--exclude-packages-list", action="store", help="Packages to be excluded from test e.g. --exclude-packages-list=fledge-south-sinusoid,fledge-filter-log")
