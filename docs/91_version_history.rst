...
- **Fledge Core**
    ...
    - New Features
       ...
       - A new mechanism has been introduced that allows configuration items within a category to have a group associated with them. This allows items that relate to particular mechanism be recognised as related by clients of the API and display decisions to be taken based on these groups.
...
- **Services & Plugins**
    ...
    - Bug Fixes
       ...
       - A number of bug fixes have been made to the North OPC UA Client plugin to improve the logging and responsiveness of the plugin.
