...
insert into foglamp.scheduled_processes (name, script) values ('sending process', '["python3", "-m", "tasks.north.sending_process", "--stream_id", "1", "--debug_level", "1"]');
-- FogLAMP statistics into PI
insert into foglamp.scheduled_processes (name, script) values ('statistics to pi','["python3", "-m", "tasks.north.sending_process", "--stream_id", "2", "--debug_level", "1"]');
