...
class TestConfigurationManager:
    ...
    async def test_delete_recursively_parent_category(self, mocker, reset_singleton):
        @asyncio.coroutine
        def mock_coro(a, b):
            return expected_result
        ...
        ret_val = await c_mgr.delete_recursively_parent_category("A")
        assert expected_result == ret_val
    ...
    async def test_delete_recursively_parent_category_exception(self, mocker, reset_singleton):
        @asyncio.coroutine
        def mock_coro(a, b):
            return expected_result
        ...
        with pytest.raises(ValueError) as excinfo:
            await c_mgr.delete_recursively_parent_category("A")
        assert str(msg) == str(excinfo.value)
