...
The full source code, includign the *DHT11* class can be found in GitHub |fledge DHT|
...
- Set the environment variable FLEDGE_ROOT to the diretory in which you built Fledge
