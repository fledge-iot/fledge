...
\set new_ts now()::timestamp(0) - 'interval \'20 minute\''
...
\set new_ts now()::timestamp(0) - 'interval \'15 minute\''
...
\set new_ts now()::timestamp(0) - 'interval \'10 minute\''
...
\set new_ts now()::timestamp(0) - 'interval \'5 minute\''
