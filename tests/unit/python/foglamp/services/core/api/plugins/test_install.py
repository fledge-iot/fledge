...
class TestPluginInstall:
    ...
    @pytest.mark.parametrize("param, message", [
        ({"create": "blah"}, "URL, checksum, plugin type and format post params are mandatory."),
        ({"url": "http://blah.co.in"}, "URL, checksum, plugin type and format post params are mandatory."),
        ({"format": "tar"}, "URL, checksum, plugin type and format post params are mandatory."),
        ({"compressed": "false"}, "URL, checksum, plugin type and format post params are mandatory."),
        ({"type": "north"}, "URL, checksum, plugin type and format post params are mandatory."),
        ({"checksum": "4015c2dea1cc71dbf70a23f6a203eeb6"},
         "URL, checksum, plugin type and format post params are mandatory."),
        ...
        ({"type": "north", "checksum": "4015c2dea1cc71dbf70a23f6a203eeb6"},
         "URL, checksum, plugin type and format post params are mandatory."),
        ({"url": "http://blah.co.in", "format": "deb", "checksum": "4015c2dea1cc71dbf70a23f6a203eeb6"},
         "URL, checksum, plugin type and format post params are mandatory."),
        ({"url": "http://blah.co.in", "format": "deb", "type": "blah", "checksum": "4015c2dea1cc71dbf70a23f6a203eeb6"},
