...
PerformanceMonitor *PerformanceMonitor::m_instance = 0;
...
/**
 * Write the performance data via the storage layer
 *
 * @param table		Name of the table to write
 * @param values	Values to write to the table
 */
void PerformanceMonitor::writeData(const std::string& table, const InsertValues& values)
{
