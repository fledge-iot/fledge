...
ALTER TABLE foglamp.tasks ADD COLUMN schedule_name character varying(255) NOT NULL DEFAULT 'foo';
ALTER TABLE foglamp.tasks ALTER COLUMN schedule_name DROP DEFAULT;
